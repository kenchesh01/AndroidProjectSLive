...
public class LoanModule1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    // declare instance variables required for the navigation drawer
    private ActionBarDrawerToggle mToggle;
    private AdView adView;
    // declare package prefix , LOAN_MESSAGE constant and key values
    public final static String LOAN_MESSAGE1 = "com.transposesolutions.bankingcalculator.mPayment";
    public final static String LOAN_MESSAGE2 = "com.transposesolutions.bankingcalculator.mPrincipal";
    public final static String LOAN_MESSAGE3 = "com.transposesolutions.bankingcalculator.mInterest";
    public final static String LOAN_MESSAGE4 = "com.transposesolutions.bankingcalculator.mPayments";
    public final static String LOAN_MESSAGE5 = "com.transposesolutions.bankingcalculator.mLoan";
    public final static String LOAN_MESSAGE6 = "com.transposesolutions.bankingcalculator.mTerm";
    public final static String LOAN_MESSAGE7 = "com.transposesolutions.bankingcalculator.mRate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loan_module1);
        ...
        calculateButton.setOnClickListener(view -> {
            ...
            //check for required maximum value for annual interest rate
                ...
                Intent intent = new Intent(LoanModule1.this, LoanModule2.class);
                ...
                bundle.putString(LOAN_MESSAGE1, mPayment);
                bundle.putString(LOAN_MESSAGE2, mPrincipal);
                bundle.putString(LOAN_MESSAGE3, mInterest);
                bundle.putString(LOAN_MESSAGE4, mPayments);
                bundle.putString(LOAN_MESSAGE5, mLoan);
                bundle.putString(LOAN_MESSAGE6, mTerm);
                bundle.putString(LOAN_MESSAGE7, mRate);
    ...
    private void requiredCheck1() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LoanModule1.this);
